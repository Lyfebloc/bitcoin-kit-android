package com.lyfebloc.bitcoinkit
...
import com.lyfebloc.bitcoincore.blocks.validators.*
...
import com.lyfebloc.bitcoinkit.BitcoinKit.Listener
import com.lyfebloc.bitcoinkit.BitcoinKit.NetworkType
import com.lyfebloc.hdwalletkit.*
import com.lyfebloc.hdwalletkit.HDWallet.Purpose
import com.lyfebloc.hodler.HodlerPlugin
...
class BitcoinKit : AbstractKit {
    ...
    constructor(
        ...
        network = when (networkType) {
            ...
            NetworkType.TestNet -> {
                initialSyncApi = BCoinApi("https://btc-testnet.lyfebloc.xyz/api")
                TestNet()
            }
            NetworkType.RegTest -> {
